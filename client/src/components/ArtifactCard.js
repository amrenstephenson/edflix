...
function ArtifactCard(props) {
    ...
    return (
        <div
            style={{ borderRadius: '2rem', cursor: 'pointer', background: `url("${props.artifact.ThumbnailURL}")`, backgroundSize: 'cover', border: '0.5px solid white', textShadow: '0px 0px 2px black;', ...props.style }}
